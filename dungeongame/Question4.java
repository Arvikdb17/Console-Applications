...
public class Question4 {
	...
	public static void main(String[] args) {
        ...
        if(hunterSteps<monsterSteps)
        	...
        	int stepToTrigger=rec(hRow,hCol,tRow,tCol,board,0);
        	int stepFromTrigger=rec(tRow,tCol,gRow,gCol,board,0);
        	System.out.println("Hunter will reach with "+(stepToTrigger+stepFromTrigger)+" steps");
        }
